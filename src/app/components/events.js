...
export const SpaceEvents = () => {
  ...
  return (
    <div id="events" style={{ textAlign: "center" }}> {/* De hoofd container wordt gecentreerd */}      <h2 style={{ backgroundColor: "#4B0082", color: "white", padding: "10px", borderRadius: "5px" }}>Events 🌌</h2>
      {events.length === 0 ? (
